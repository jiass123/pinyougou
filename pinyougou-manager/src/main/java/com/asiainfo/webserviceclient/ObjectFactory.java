 ...
 * generated in the com.asiainfo.webserviceclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webserviceserver.asiainfo.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webserviceserver.asiainfo.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.asiainfo.webserviceclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserviceserver.asiainfo.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserviceserver.asiainfo.com/", name = "queryWeather")
